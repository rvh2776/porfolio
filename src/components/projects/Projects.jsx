...
const Projects = React.forwardRef((props, ref) => {
  ...
  <div className="project-content"/>
    ...
    <p className="project-description">
      Aplicación web que permite crear y gestionar una página de películas. Utilizando tecnologías como HTML, CSS, JavaScript y Webpack, la aplicación ofrece una experiencia completa para gestionar y visualizar películas.
    </p>
    <p className="project-features"/>
      ...
      - Detalle de Películas: Al hacer clic en una tarjeta, se muestra un detalle ampliado de la película en una tarjeta más grande, incluyendo sinopsis y otros detalles importantes.<br/>
    ...
    <div className="button-container">
      ...
      <a href="URL_DE_LA_DEMO" className="btn btn-secondary">Ver Demo</a>
    </div>
